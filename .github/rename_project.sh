...
do
    ...
    sed -i "s/invenio-inspector/$project_name/g" $filename
    sed -i "s/invenio-inspector/$urlname/g" $filename
    sed -i "s/CLI tool to list stuff about an invenio installation/$description/g" $filename
    sed -i "s/2022-08-17/$creation_date/g" $filename
